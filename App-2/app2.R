...
ui <- fluidPage(
  ...
  fluidRow(
    column(12, div(class = "main-title text-center",
  ...
  fluidRow(
    column(
      ...
      div(class = "sidebar-panel",
          helpText("Explore the gene ontology results from either the diet experiment or the water deprivation expeiment."),
