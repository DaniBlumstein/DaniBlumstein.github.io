...
# }
sites <- read.csv("~/Documents/website_files/sampling_sites.csv")
...
leaflet() %>% 
  ...
  addAwesomeMarkers(data = sites[sites$species == "Powelliphanta",], 
                    ...
                    popup="") %>%
  addLayersControl(
    overlayGroups = c("cisco", "Ruellia caroliniensis", "Cuphea viscosissima", "Desmodium paniculatum", "Phytolacca americana", "lake sturgeon", "Powelliphanta" ),
