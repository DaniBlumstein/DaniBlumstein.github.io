...
icon.deepSculpin <- makeAwesomeIcon(icon = 'ship', markerColor = 'grey', iconColor = 'black')
icon.spoonhead <- makeAwesomeIcon(icon = 'ship', markerColor = '#482677FF', iconColor = 'black')
icon.kiyi <- makeAwesomeIcon(icon = 'ship', markerColor = '#287D8EFF', iconColor = 'black')
icon.siscowet <- makeAwesomeIcon(icon = 'ship', markerColor = '#20A387FF', iconColor = 'black')
